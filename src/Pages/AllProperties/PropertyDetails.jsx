...
const PropertyDetails = () => {
  ...
  const property = loadData.propertyData;
  const reviews = loadData.reviewData;
    ...
    <div>
      ...
      <div className="flex flex-col m-10 justify-center ">
        ...
        <div className="max-w-md mx-auto">
          <h1 className="text-xl m-10 font-semibold text-center">
            Relevant reviews of this property:
          </h1>
          {reviews.map((review, idx) => (
            <div key={idx}>
              <div className="chat chat-start">
                ...
                <div className="chat-bubble min-w-full">{review.review}</div>
